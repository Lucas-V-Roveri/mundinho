...
export function ChunkLoader() {
  ...
  return (
    <>
      <noscript><style>{`[data-chunk-loader]{display:none!important}`}</style></noscript>
      <div data-chunk-loader role="status" aria-live="polite" aria-label="Carregando o mundinho" className="fixed inset-0 z-[120] grid place-items-center bg-night-950 text-paper-50">
        <div className="w-[min(88vw,32rem)] border-4 border-torch-700 bg-night-900 p-6 shadow-pixel">
          ...
          <p className="mt-2 font-label text-xl text-paper-100">acendendo as tochas...</p>
