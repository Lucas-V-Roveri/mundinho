...
export function BackstageView() {
  ...
  return <div className="space-y-6 page-enter">
    <header className="pixel-surface panel-paper p-5 text-ink-900">
      <p className="font-label text-2xl text-wood-700">bibliotecas, performance, compat e cosméticos</p>
