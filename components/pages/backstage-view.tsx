...
export function BackstageView() {
  ...
  return <div className="space-y-6 page-enter">
    <header className="pixel-surface panel-stone p-5"><p className="font-label text-2xl text-wood-700">bibliotecas, performance, compat e cosméticos</p><h1 className="mt-2 font-display text-lg leading-relaxed sm:text-2xl">Bastidores</h1><p className="mt-3 max-w-4xl leading-7">{data.note}</p></header>
