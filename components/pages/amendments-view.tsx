...
export function AmendmentsView() {
  ...
  if (!data) return <p className="pixel-surface panel-paper p-5 text-ink-900">Conteúdo de Amendments indisponível nesta prévia.</p>;
  return <div className="space-y-6 page-enter">
    <header className="pixel-surface panel-paper p-5 text-ink-900"><p className="font-label text-2xl text-wood-700">consulta fixa</p><h1 className="mt-2 font-display text-lg leading-relaxed text-ink-900 sm:text-2xl">Amendments</h1><p className="mt-3 max-w-4xl leading-7 text-ink-900">{data.intro}</p></header>
